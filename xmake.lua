...
set_config("vbase_root", is_root)
set_config("vbase_project_dir", os.scriptdir())

-- global options
option("VBase_build_examples") -- build examples?
    set_default(true)
    set_showmenu(true)
    set_description("Enable VBase examples")
option_end()
...
if has_config("VBase_build_examples") then
    includes("examples")
end